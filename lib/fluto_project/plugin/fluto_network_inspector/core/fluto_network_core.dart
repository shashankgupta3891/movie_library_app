...
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/core/fluto_network_logger.dart';
...
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/model/fluto_http_error.dart';
...
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/utils/alice_utils.dart';
import 'package:rxdart/rxdart.dart';

class FlutoNetworkCore {
  ...
  final bool _isInspectorOpened = false;
  StreamSubscription? _callsSubscription;
  final bool _notificationProcessing = false;
  ...
  AliceHttpCall? _selectCall(int requestId) =>
      callsSubject.value.firstOrNullWhere((call) => call.id == requestId);
