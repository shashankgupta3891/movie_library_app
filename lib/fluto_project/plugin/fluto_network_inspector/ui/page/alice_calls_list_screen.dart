...
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/helper/alice_alert_helper.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/model/alice_menu_item.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/model/alice_sort_option.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/model/alice_tab_item.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/model/fluto_http_call.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/ui/page/alice_call_details_screen.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/ui/widget/alice_call_list_item_widget.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/ui/widget/alice_log_list_widget.dart';
import 'package:movie_playlist/fluto_project/plugin/fluto_network_inspector/ui/widget/alice_raw_log_list_widger.dart';

import 'alice_stats_screen.dart';

class AliceCallsListScreen extends StatefulWidget {
  final FlutoNetwork _flutoNetwork;

  const AliceCallsListScreen(this._flutoNetwork, {super.key});
...
class _AliceCallsListScreenState extends State<AliceCallsListScreen>
  ...
  FlutoNetworkCore get aliceCore => widget._flutoNetwork.aliceCore;
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      textDirection: widget._flutoNetwork.aliceCore.directionality ??
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              for (final item in _tabItems) Tab(text: item.title.toUpperCase())
            ],
          ),
        ),
        body: TabBarView(
  ...
  void _onLogsClearClicked() {
    setState(() {
      if (isAndroidRawLogsEnabled) {
        widget._flutoNetwork.aliceCore.aliceLogger.clearAndroidRawLogs();
      } else {
        widget._flutoNetwork.aliceCore.aliceLogger.clearLogs();
      }
    });
  }
  ...
  void _onListItemClicked(AliceHttpCall call) {
    Navigator.push<void>(
      ...
      MaterialPageRoute(
        builder: (context) =>
            AliceCallDetailsScreen(call, widget._flutoNetwork.aliceCore),
      ),
    );
  }
  ...
  void _showStatsScreen() {
    Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (context) => AliceStatsScreen(widget._flutoNetwork.aliceCore),
      ),
    );
  }
  ...
  Widget _buildLogsWidget() {
    final aliceLogger = widget._flutoNetwork.aliceCore.aliceLogger;
